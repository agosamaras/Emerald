...
#     # sel = RandomForestClassifier(max_depth=None, random_state=0, n_estimators=i) #89.72 - 17
#     # sel = AdaBoostClassifier(n_estimators=i, random_state=0) #88.64 - 15
#     # sel = TabPFNClassifier(device='cpu', N_ensemble_configurations=i) #91.02 - 3
#     # sel = xgboost.XGBRegressor(objective="binary:hinge", random_state=42) #87.96
#     # sel = CatBoostClassifier(n_estimators=i, learning_rate=0.1, verbose=False) #90.82 - 157
#     if i%10:
#         print(i)
